...
class GameWindow < Gosu::Window
  ...
  def initialize
    ...
    @galaxy_stars_count = 100
    @galaxy_gravity_constant = 0.00001
    @galaxy_joining_distance = 2
    @galaxy_force_change_distance = 4
    @galaxy_distribution = :unitary

    @galaxy = Galaxy.new(@galaxy_size, @galaxy_stars_count, @galaxy_gravity_constant, @galaxy_force_change_distance, @galaxy_distribution)
